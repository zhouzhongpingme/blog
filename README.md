...
```bash
git clone https://github.com/zhouzhongpingme/hexo-theme-huweihuang.git ./hexo-huweihuang
cd hexo-huweihuang
npm install
```
...
# Have fun ^_^ 
Please <a class="github-button" href="https://github.com/zhouzhongpingme/hexo-theme-huweihuang" data-icon="octicon-star" aria-label="Star huweihuang/hexo-theme-huweihuang on GitHub">Star</a> this Project if you like it! <a class="github-button" href="https://github.com/zhouzhongpingme" aria-label="Follow @huweihuang on GitHub">Follow</a> would also be appreciated!
Peace!
